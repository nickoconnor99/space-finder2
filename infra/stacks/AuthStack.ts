...
export class AuthStack extends Stack {
  ...
  private createAdminsGroup() {
    new CfnUserPoolGroup(this, "SpaceAdmins", {
      ...
      groupName: "admins",
      roleArn: this.adminRole.roleArn, //link admin role to createAdminsGroup so that users in this group will have admin permissions
    });
  }
  ...
  private createIdentityPool() {
    ...
    //new value of identity pool outside stack so use ref
